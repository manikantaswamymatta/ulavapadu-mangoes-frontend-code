...
import shippingRates from "@/src/data/shippingRates.json";
import {
...
function getDeliveryRate(zone: string, totalWeightKg: number): number {
  const rows = ((shippingRates as any).slabs || []) as ShippingRateRow[];
