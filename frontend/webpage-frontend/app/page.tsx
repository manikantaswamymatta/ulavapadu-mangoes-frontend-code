...
const FALLBACK_IMAGE = "/ulavapadumangoes-logo.jpg";
    ...
    <>
      <main className="mango-home">
        ...
        <div className="mango-home__container mango-home__hero-content">
          ...
          <h1>Fresh and Organic Mangoes, Farm to Home</h1>
          <p className="mango-home__subtext">
            We aim at delivering fresh and organic mangoes directly from farm to your home, with home delivery available across India.
          </p>
        ...
        <section className="mango-home__container mango-home__section">
        ...
        <section className="mango-home__container mango-home__section">
        <div className="mango-home__process">
          <h2>How We Deliver</h2>
          <div>
            <article>
              <h3>1. Choose Your Variety</h3>
              <p>Pick your favorite mango varieties and products with clear price-per-kg options.</p>
            </article>
            <article>
              <h3>2. Place Your Order</h3>
              <p>Order quickly through our online pages and WhatsApp support.</p>
            </article>
            <article>
              <h3>3. Receive Farm Fresh Delivery</h3>
              <p>Directly from farm to home with reliable delivery in {deliveryArea}.</p>
            </article>
          </div>
        </div>
        </section>
